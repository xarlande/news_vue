...
const newsPopular = await useFetch<{ articles: Array<any> }>(
    "/api/top-headlines",
    {
        query: {
            category: "general",
...
const newsTechnology = await useFetch<{ articles: Array<any> }>(
    "/api/top-headlines",
    {
        query: {
            category: "technology",
...
const newsBusiness = await useFetch<{ articles: Array<any> }>(
    "/api/top-headlines",
    {
        query: {
            category: "business",
...
const newsSport = await useFetch<{ articles: Array<any> }>(
    "/api/top-headlines",
    {
        query: {
            category: "sport",
